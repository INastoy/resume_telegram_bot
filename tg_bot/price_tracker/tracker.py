...
def get_product_data(product_url) -> dict:
    ...
    product_new_price = product_soup.find('span', class_='ProductHeader__price-default_current-price').text.strip().replace(' ', '')
    ...
    #     tracker_result = {
    #         'product_name': 'name',
    #         'product_old_price': int(q[0]),
    #         'product_new_price': int(q[1]),
    #         'product_bonuses': int(q[2]),
    #     }
